...
describe('basic-querying', function () {
  ...
  describe('findByIds', function () {
    ...
    before(function(done) {
      ...
      var people = [
        { id: 1, name: 'a', vip: true, seq: 1 },
        { id: 2, name: 'b', seq: 2 },
        { id: 3, name: 'c', seq: 3 },
        { id: 4, name: 'd', vip: true, seq: 4 },
        { id: 5, name: 'e', seq: 5 },
        { id: 6, name: 'f', seq: 6 }
      ];
  ...
  describe('find', function () {
    ...
    it('should query collection with skip & limit', function (done) {
      User.find({skip: 1, limit: 4, order: 'seq'}, function (err, users) {
        ...
        // This is going to force a scan since we dont' specify any criteria, thus,
        // we can't insist on the order.
    ...
    /**
     * This will fail because of dynamodb ordering constraints.
     *
    ...
    it('should support number "gt" that is satisfied by null value', function (done) {
      User.find({order: 'seq', where: { order: { "gt": null }
        ...
        //Null is not a viable value in a gt operation in dynamodb.
        should.exist(err);
        done();
      });
    });
    ...
    it('should support boolean "gte" that is satisfied', function (done) {
      User.find({order: 'seq', where: { vip: { "gte":  true}
        ...
        //Not a valid comparison in dynamo.
        should.exist(err);
        done();
      });
    });
  ...
  describe('findOne', function () {
    ...
    /**
     * Not enforcing this test as dynamodb does not order this way.
     *
