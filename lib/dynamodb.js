...
exports.initialize = function initializeDataSource(dataSource, cb) {
  ...
  //Set the region so we are using the right dynamo instance
  //This matters alot, especialy for local DynamoDB instances that
  //will partition the data by accessKeyId and region.
  var db = new AWS.DynamoDB({
    region: process.env.AWS_REGION
  });


  var client = new DOC.DynamoDB(db);
